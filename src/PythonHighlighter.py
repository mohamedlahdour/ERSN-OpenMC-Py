...
STYLES = {
    'keyword': format('blue'),
    'if_keyword': format('orange', 'bold'),
    'or_keyword': format('darkOrange', 'bold'),
    'import_keyword': format('orange'),
    ...
    'self': format('pink', 'italic'),
    'numbers': format('darkBrown'),
}
...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    keywords = [ 'assert', 'break', 'class', 'continue', 'def', 'del', 'except', 'exec', 'finally',
        'from', 'global', 'import', 'lambda', 'pass', 'print', 'raise', 'return', 'yield',
        'None', 'True', 'False', ]
    if_keywords = ['if', 'elif', 'else', 'is', 'for', 'while','try', 'except', ]
    or_keywords = [ 'in', 'and', 'or', 'not', ]
