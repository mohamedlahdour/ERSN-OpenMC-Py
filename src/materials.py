...
NATURAL_ABUNDANCE = {
    'None': 0.000000, 'H1': 0.99984426, 'H2': 0.00015574, 'He3': 0.000002,
    ...
    'U238': 0.992742, 'Pu239' : 1., 'Pu240' : 1.,
    'Pu241' : 1., 'Pu242' : 1.
}

# Dictionary to give element symbols from IUPAC names
# (and some common mispellings)
ELEMENT_SYMBOL = {'none': 'None', 'neutron': 'n', 'hydrogen': 'H', 'helium': 'He',
...
ATOMIC_SYMBOL = {119: 'None', 0: 'n', 1: 'H', 2: 'He', 3: 'Li', 4: 'Be', 5: 'B', 6: 'C',
...
THERMAL_SCATTERING = ["None","c_Al27", "c_Be_in_BeO", "c_Be", "c_C6H6", "c_C_in_SiC", 
                      ...
                      "c_H_in_ZrH", "c_H_in_CH4_liquid", "c_N_in_UN",
                      "c_O_in_BeO", "c_O_in_D2O", "c_O_in_H2O_ice",
                      "c_O_in_UO2", "c_ortho_D", "c_ortho_H", "c_para_D",
                      "c_para_H", "c_Si_in_SiC", "c_SiO2_alpha", "c_H_in_CH4_solid",
                      "c_U_in_UN", "c_U_in_UO2", "c_Y_in_YH2", "c_Zr_in_ZrH"]


ELEMENTS = ATOMIC_SYMBOL.values()
ELEMENTS_list = list(ELEMENTS)

NUCLIDES = NATURAL_ABUNDANCE.keys()
NUCLIDES_list = list(NUCLIDES)

SAB_list = list(THERMAL_SCATTERING)
